function TerrainCell(terrain, i, j, value, water, sed, meta) {
...
TerrainCell.prototype = _.extend({
        rawDataToBuffer: function(buffer, full){
    ...
    require('./TerrainCellLib/io')
);

TerrainCell.fromBuffer = require('./TerrainCellLib/fromBuffer')(TerrainCell);
