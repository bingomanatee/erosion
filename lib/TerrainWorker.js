...
TerrainWorker.prototype = {
    ...
    updateTerrain: function (data) {
        ...
        return q.Promise(function (resolve, reject) {
            ...
            function finish() {
               // console.log('done with ', data.script, 'for ', this.terrain.toJSON());
                if (data.feedback) {
                    resolve({
            ...
            function loop() {
                executor(this).then(function () {
                    ++count;
                   // console.log('finished rep ', count, 'of', data.reps, 'for', this.terrain.toJSON());
