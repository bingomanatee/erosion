...
function Terrain(iSize, jSize, values, iStart, jStart) {
    ...
    this.state = StateMachine.create({
        initial: 'new',
        events: [
            {name: 'requestWorker', from: 'new', to: 'workerrequested'},
            {name: 'workerMade', from: 'workerrequested', to: 'workercreated'},
            {name: 'isWorker', from: 'new', to: 'isworker'},
            {name: 'isLive', from: ['new','isworker'], to: 'live'},
            {name: 'hasProblem', from: '*', to: 'problem'}
        ]
    });
